...
class Game < ActiveRecord::Base
  ...
  def populate_board!
    ...
    pieces.create(:type => 'Queen', :color => "Black", :x_coordinate => 3, :y_coordinate => 7)
    pieces.create(:type => 'King', :color => "Black", :x_coordinate => 4, :y_coordinate => 7)
    ...
    pieces.create(:type => 'Queen', :color => "White", :x_coordinate => 3, :y_coordinate => 0)
    pieces.create(:type => 'King', :color => "White", :x_coordinate => 4, :y_coordinate => 0)
